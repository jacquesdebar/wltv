    ...
    <div className="row mt-2 mb-3 pt-3">
        <div className="col-5 float-center text-center">
            <span id="ikonz" className="d-inline-block">
                <a id="instagram" href="https://www.instagram.com/wilsonlikethevolleyball_/">
                ...
                <a id="soundcloud" href="https://soundcloud.com/wilsonlikethevolleyball/">
                    <i className="fab fa-soundcloud" aria-label="soundcloud" />
                </a>
                <a id="spotify" href="https://open.spotify.com/artist/4hba9BjCS4J6XkfSaKyxL1">
                    <i className="fab fa-spotify" aria-label="spotify" />
                </a>
                <a id="apple" href="https://music.apple.com/us/artist/wilsonlikethevolleyball/1289135886">
