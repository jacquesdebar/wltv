...
export default function FullWidthGrid() {
  ...
  return (
    <div className={classes.root}>
      <Grid container direction='row-reverse' spacing={0} className={classes.container}>
        ...
        >
          ...
          <h2>
            ...
            colors. im seattle based, my favorite colors right now are pink and
            blue, and i would love it if you would share my music with your
            friends :)
          </h2>
          </Grid>
          <Grid
